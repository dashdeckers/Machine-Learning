...
To plot the results using the `plot.py` script, you need to download the JSON data for each of the logs via Tensorboard. Then, place them in a folder called `json` in the same directory as the script and run:\
`python plot.py`
